...
class AddSuccessorFormPage extends StatefulWidget {
  AddSuccessorFormPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  AddSuccessorFormPageState createState() => AddSuccessorFormPageState();
}
...
class AddSuccessorFormPageState extends State<AddSuccessorFormPage> {

...
class FamilyTreeInfoDialog extends StatelessWidget {
                            ...
                            children: [
                              Container(
                                ...
                                child: Align(
                                  ...
                                  child: Wrap(children: [
                                    Text(
                                      'The employee is the center of the family tree',
                            ...
                            children: [
                              Container(
                                ...
                                child: Align(
                                  ...
                                  child: Wrap(children: [
                                    Text(
                                      'The employee is ready to be a successor',
                                      textAlign: TextAlign.left,
                                      style: TextStyle(
                                          letterSpacing: 0.5,
                                          fontSize: 13,
                            ...
                            children: [
                              Container(
                                ...
                                child: Align(
                                  ...
                                  child: Wrap(children: [
                                    Text(
                                      'The employee still need a development to be a successor',
                                      textAlign: TextAlign.left,
                                      style: TextStyle(
                                          letterSpacing: 0.5,
                                          fontSize: 13,

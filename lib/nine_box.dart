...
class nineBoxPage extends StatefulWidget {
  nineBoxPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  nineBoxPageState createState() => nineBoxPageState();
}

class nineBoxPageState extends State<nineBoxPage> {
  @override
